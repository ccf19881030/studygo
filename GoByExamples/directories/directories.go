...
//https://gobyexample-cn.github.io/directories
...
func main() {
	...
	// 创建这个临时目录后，一个好的习惯是：使用defer删除这个目录。
	// os.RemoveAll会删除整个目录（类似于rm -rf)
	...
	// Walk接受一个路径和回调函数，用于处理访问到的每个目录和文件。
